...
Start dev as `SERVER_PORT=4700 bun run dev` whenever the installed app may be running, since both take 4696 by default; `docs/dev-server-port.md` has the rest.
