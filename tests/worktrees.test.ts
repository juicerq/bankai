...
describe("reporting a refused removal", () => {
	test("git's own reason reaches the caller without its fatal prefix", () => {
		const err = Object.assign(new Error("Command failed: git worktree remove /tmp/bankai-solo"), {
