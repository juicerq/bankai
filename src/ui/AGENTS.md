...
- `UI-STRUCTURE.md` — organização da UI (`components/`, `-utils/`, imports diretos, kebab-case, um componente por arquivo). Ler antes de criar ou mexer em qualquer componente.
